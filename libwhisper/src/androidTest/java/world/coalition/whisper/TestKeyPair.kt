...
class TestKeyPair {
    ...
    fun stage1_testSessionKeyInsertion() {
        ...
        val k1 =  Base64.encodeToString(ECUtil.savePrivateKey(kp1.private as X25519PrivateKeyParameters), Base64.NO_WRAP) + Base64.encodeToString(ECUtil.savePublicKey(kp1.public as X25519PublicKeyParameters), Base64.NO_WRAP)


        // this one should return previous because not expire
        val kp2 = db.getCurrentKeyPair(20, 100)
        val k2 =  Base64.encodeToString(ECUtil.savePrivateKey(kp2.private as X25519PrivateKeyParameters), Base64.NO_WRAP) + Base64.encodeToString(ECUtil.savePublicKey(kp2.public as X25519PublicKeyParameters), Base64.NO_WRAP)
        ...
        val k3 =  Base64.encodeToString(ECUtil.savePrivateKey(kp3.private as X25519PrivateKeyParameters), Base64.NO_WRAP) + Base64.encodeToString(ECUtil.savePublicKey(kp3.public as X25519PublicKeyParameters), Base64.NO_WRAP)
        assertThat(k3, IsNot(equalTo(k2)))

        // this one should create a new key because previous expired (120 > 10 + 100)
        val kp4 = db.getCurrentKeyPair(240, 100)
        val k4 =  Base64.encodeToString(ECUtil.savePrivateKey(kp4.private as X25519PrivateKeyParameters), Base64.NO_WRAP) + Base64.encodeToString(ECUtil.savePublicKey(kp4.public as X25519PublicKeyParameters), Base64.NO_WRAP)
        assertThat(k4, IsNot(equalTo(k3)))

        // this timestamp < current one so it matches
        val kp5 = db.getCurrentKeyPair(120, 100)
        val k5 =  Base64.encodeToString(ECUtil.savePrivateKey(kp5.private as X25519PrivateKeyParameters), Base64.NO_WRAP) + Base64.encodeToString(ECUtil.savePublicKey(kp5.public as X25519PublicKeyParameters), Base64.NO_WRAP)
